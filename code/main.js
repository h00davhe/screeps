...
module.exports.loop = function () {
    ...
    if (harvester1.length > 1 && harvester2.length > 1) {
        ...
        if (remoteHarvester2.length < 2) {//todo remove antother move when road is finished
            var newName = Game.spawns['Spawn1'].createCreep([WORK,WORK,WORK,WORK,CARRY,CARRY,CARRY,CARRY,CARRY,CARRY,CARRY,CARRY,CARRY,CARRY,MOVE,MOVE,MOVE,MOVE,MOVE,MOVE,MOVE,MOVE], undefined, {role: 'remoteHarvester2', destinationRoom: REMOTEHARVESTTARGET, sourceNumber: 1});
